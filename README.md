...
```
Dashboard-capturaleads.com/
├── header-capturaleads.html      # Header principal del sitio
├── footer-capturaleads.html      # Footer con información de contacto
├── hero-capturaleads.html        # Sección hero de la landing principal
├── README.md                     # Este archivo
└── [Próximamente]
    ├── landing-templates/        # Templates de landing pages
    ├── email-templates/          # Templates de emails automáticos
